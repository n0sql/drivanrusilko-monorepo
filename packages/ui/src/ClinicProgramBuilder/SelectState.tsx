...
const SelectState = ({usstates}:{usstates:any}) => {
  return (
    <div className="">
      ...
      <div className="relative mb-3">
        ...
        <select
          id="state"
          placeholder="dfdfd"
          className="bg-gray-50 border h-16 border-gray-300 text-gray-900  font-bold rounded  shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer"
        >
