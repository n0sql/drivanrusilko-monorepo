...
const DrawerMenu = ({menus}:{menus:any}) => {
  return (
    <ul
      className=" relative  list-none !w-screen px-6 space-y-6 overflow-y-scroll h-[calc(100vh-8rem)] mylist"
      data-te-sidenav-menu-ref
    >
      <h4 className="text-left text-gray-300 px-2 ">Explore treatments</h4>
