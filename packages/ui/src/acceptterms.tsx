...
export const AcceptTerms = ({ handleAcceptTerms }: AcceptTermsProps) => {


  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    handleAcceptTerms(event.target.checked);
  };
  ...
  return (
    ...
    <label className="mt-px font-light text-gray-700 cursor-pointer select-none" htmlFor="link">
