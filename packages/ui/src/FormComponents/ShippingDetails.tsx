...
const ShippingDetails = ({ goToStep, usstates }: any) => {
  return (
    <div>
      <div className="">
        <div className=" border-gray-900/10 ">
          <h1 className="text-primary">Shipping Info & Address</h1>
          <p className="mt-1 ">
          ...
          <div className=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="relative sm:col-span-3">
              <select
                ...
                autoComplete="state"
                placeholder="State"
                className=" m-0 block h-16 w-full rounded border border-solid border-neutral-300 text-primary bg-white bg-clip-padding px-3 py-4 text-base font-normal leading-tight text-neutral-700 ease-in-out placeholder:text-transparent focus:border-primary focus:bg-white focus:pb-[0.625rem] focus:pt-[1.625rem] focus:text-neutral-700 focus:shadow-te-primary focus:outline-none dark:bg-neutral-800 dark:text-neutral-200 [&:not(:placeholder-shown)]:pb-[0.625rem] [&:not(:placeholder-shown)]:pt-[1.625rem] peer"
              >
              ...
              <label
                htmlFor="state"
                className="absolute text-sm text-gray-500 dark:text-gray-400 origin-[0_0] duration-300 transform -translate-y-2 text-neutral-700 transition-[opacity,_transform] duration-100 ease-in-out  scale-75 top-4  peer-focus:translate-x-[0.15rem]  left-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.85] peer-focus:-translate-y-4 motion-reduce:transition-none peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:scale-[0.85] peer-[:not(:placeholder-shown)]:opacity-[0.65]"
              >
                State
              </label>
            </div>
            ...
            <div className="relative sm:col-span-full">
              ...
              <label
                htmlFor="state"
                className="absolute text-sm text-gray-500 dark:text-gray-400 origin-[0_0] duration-300 transform -translate-y-2 text-neutral-700 transition-[opacity,_transform] duration-100 ease-in-out  scale-75 top-4 z-10 peer-focus:translate-x-[0.15rem]  left-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.85] peer-focus:-translate-y-4 motion-reduce:transition-none peer-[:not(:placeholder-shown)]:translate-x-[0.15rem] peer-[:not(:placeholder-shown)]:scale-[0.85] peer-[:not(:placeholder-shown)]:opacity-[0.65]"
              >
                Country
              </label>
            </div>
