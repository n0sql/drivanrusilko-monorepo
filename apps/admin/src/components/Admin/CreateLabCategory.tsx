        ...
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <form method="POST" onSubmit={handleSubmit}>
            ...
            <input
              ...
              onChange={(e: any) => {
                setLabCategory({ ...labCategory, name: e.target.value });
              }}
