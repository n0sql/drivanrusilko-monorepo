...
const Sometable = ({ categories }: any) => {
  ...
  var paginatedCategories = categories.slice(
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    {["Category", "Labs", "Edit", "Delete"].map((item, index) => (
                  ...
                  {paginatedCategories.map((item: any, index: number) => {
                    return (
                      <tr key={index} className="border-b dark:border-gray-700">
                        ...
                        <td className="px-4 py-3">{item?.labs.length}</td>
                        <td className="px-4 py-3">
                          <button
                            type="button"
                            id={`editCategoryButton-${item.id}`}
                            data-te-toggle="modal"
                            data-te-target={`#labcategory-edit-${item.id}`}
                            data-te-ripple-init
                          ...
                          <EditLabCategory labCategory={item} />
                        </td>
                        <td className="px-4 py-3 ">
                          <button
                            type="button"
                            ...
                            data-te-toggle="modal"
                            data-te-target={`#labcategory-delete-${item.id}`}
                            data-te-ripple-init
                            data-te-ripple-color="light"
                          ...
                          <LabCategoryDelete category={item} />
                        </td>
                      </tr>
                    );
                  })}
